const makeGalleryItem = ({
    ...
    faCategory,
    categoryKey,
    enDescription: enDescription ? enDescription : enAlt,
    faDescription: faDescription ? faDescription : faAlt,
    enAlt,
    faAlt,
    ratio,
    position,
...
const galleryCatalog = [
    ...
    makeGalleryItem({
        ...
        enDescription: 'A school notice board and printed announcement display prepared by Rumi International School.',
        faDescription: 'بورد اطلاعیه و اعلان‌های چاپی مکتب که از سوی لیسه بین‌المللی رومی آماده شده‌اند.',
...
const eventShowcase = {
    featured: {
        ...
        descriptionEn: 'At Rumi, events are not separate from academic life. They extend it by giving students moments to be recognized, to celebrate, and to grow with confidence in front of their teachers, classmates, and families.',
        descriptionFa: 'در رومی، رویدادها از زندگی آموزشی جدا نیستند؛ بلکه ادامه‌ی آن‌اند. این برنامه‌ها به شاگردان فرصت می‌دهند تا دیده شوند، جشن بگیرند و در حضور آموزگاران، هم‌صنفی‌ها و خانواده‌هایشان با اعتماد رشد کنند.',
        imageAltEn: 'Graduating students stand together on stage during a formal ceremony at Rumi International School.',
        imageAltFa: 'شاگردان فارغ در جریان یک مراسم رسمی در لیسه بین‌المللی رومی روی صحنه در کنار هم ایستاده‌اند.',
    },
    highlights: [{
            ...
            descriptionEn: 'Formal procession, stage presence, speeches, and group portraits turn graduation into a respectful milestone for students and families.',
            descriptionFa: 'راه‌پیمایی رسمی، حضور روی صحنه، سخنرانی‌ها و عکس‌های گروهی، مراسم فراغت را به یک نقطه‌ی عطف محترمانه برای شاگردان و خانواده‌ها تبدیل می‌کند.',
            imageAltEn: 'Graduating students walk through the ceremony hall in formal attire while guests watch.',
            imageAltFa: 'شاگردان فارغ با لباس رسمی از میان تالار مراسم عبور می‌کنند و مهمانان آنان را تماشا می‌کنند.',
        },
        {
            ...
            descriptionEn: 'Certificates, awards, and teacher-led presentations create a warm setting for honoring effort, discipline, and academic progress.',
            descriptionFa: 'تقدیرنامه‌ها، جوایز و برنامه‌های رهبری‌شده توسط آموزگاران، فضایی گرم برای ارج‌گذاری به تلاش، انضباط و پیشرفت درسی می‌سازند.',
            imageAltEn: 'A teacher presents a certificate to a student during a recognition program at Rumi International School.',
            imageAltFa: 'آموزگاری در لیسه بین‌المللی رومی در جریان برنامه‌ی تقدیر، تقدیرنامه‌ای را به شاگردی اهدا می‌کند.',
        },
        {
            ...
            descriptionEn: 'Decor, portraits, and joyful group moments give younger learners a meaningful celebration that feels bright, warm, and age-appropriate.',
            descriptionFa: 'تزئینات، پرتره‌ها و لحظه‌های شاد گروهی، برای شاگردان خردسال جشن معناداری می‌سازند که روشن، گرم و متناسب با سن آنان است.',
            imageAltEn: 'Young students hold colorful handmade signs during a children’s day celebration.',
            imageAltFa: 'شاگردان خردسال در جریان جشن روز کودک نوشته‌های رنگارنگ دست‌ساز را در دست گرفته‌اند.',
        },
        {
            ...
            descriptionEn: 'Supervised classroom assessments reflect the school’s emphasis on concentration, structure, and steady academic practice.',
            descriptionFa: 'ارزیابی‌های زیر نظارت در صنف، نشان‌دهنده‌ی تأکید مکتب بر تمرکز، نظم و تمرین پیوسته‌ی آموزشی است.',
            imageAltEn: 'Students complete a supervised classroom assessment at Rumi International School.',
            imageAltFa: 'شاگردان در لیسه بین‌المللی رومی یک ارزیابی صنفی را زیر نظارت آموزگار تکمیل می‌کنند.',
        },
    ],
}
...
const faqSources = [{
    ...
    },
    {
        ...
        answerEn: 'Yes. Students regularly participate in recognition programs, presentations, classroom projects, and collaborative activities throughout the year.',
    ...
    },
    {
        ...
        answerEn: 'You can reach the school by phone, email, the website, or by visiting the campus in Afghanistan.',
...
export const en = {
    ...
    notFound: {
        ...
        visualDescription: 'If you were looking for school life, photos, or the latest highlights, the links below will get you back on track quickly.',
    ...
    home: {
        ...
        classroomImageAlt: 'Young students seated together during a focused classroom activity at Rumi International School.',
        classroomImageDescription: 'A closer look at everyday learning where attention, discipline, and student presence shape the classroom atmosphere.',
        ...
        galleryDescription: 'Explore classrooms, ceremonies, projects, and proud student moments across the Rumi learning experience.',
        galleryInteractionHint: 'These lower cards refresh on each visit to keep the homepage feeling alive without changing the layout.',
    ...
    about: {
        ...
        intro: 'At Rumi International School, we believe education is the foundation of a stronger future for Afghanistan. Our school provides students and families across Afghanistan with a modern learning environment built on knowledge, discipline, respect, and personal development.',
        paragraphs: [
    ...
    gallery: {
        ...
        description: 'Browse classroom moments, recognition ceremonies, children’s celebrations, and the everyday energy of learning at Rumi International School.',
    ...
    events: {
        ...
        description: 'From graduation to classroom recognition and children’s celebrations, these programs reflect the warm, academic life of Rumi.',
        featured: {
...
export const fa = {
    ...
    notFound: {
        ...
        visualDescription: 'اگر دنبال زندگی آموزشی، تصویرها یا تازه‌ترین رویدادها بودید، لینک‌های زیر شما را زود به مسیر درست برمی‌گرداند.',
    ...
    home: {
        ...
        classroomImageAlt: 'شاگردان خردسال در جریان یکی از فعالیت‌های صنفی با تمرکز در کنار هم نشسته‌اند.',
        classroomImageDescription: 'نمایی نزدیک از جریان یادگیری روزانه؛ جایی که توجه، انضباط و حضور فعال شاگردان فضای صنف را شکل می‌دهد.',
        ...
        galleryDescription: 'از صنف‌ها تا مراسم‌ها و لحظه‌های پرافتخار شاگردان، این بخش گوشه‌هایی از تجربه‌ی آموزشی رومی را نشان می‌دهد.',
        galleryInteractionHint: 'این کارت‌های پایینی در هر بازدید تازه می‌شوند تا صفحه زنده بماند، بدون آن‌که ساختار آن تغییر کند.',
    ...
    about: {
        ...
        intro: 'در لیسه بین‌المللی رومی، ما باور داریم که آموزش زیربنای آینده‌ای نیرومندتر برای افغانستان است. رومی برای شاگردان و خانواده‌ها در سراسر افغانستان، محیطی آموزشی و مدرن فراهم می‌کند که بر دانش، انضباط، احترام و رشد فردی استوار است.',
        paragraphs: [
        ...
        visionText: 'چشم‌انداز ما رشد به‌عنوان نهادی محترم است که به‌خاطر کیفیت آموزش، حمایت معنادار از شاگردان و فرهنگی که تلاش را به فرصت تبدیل می‌کند شناخته شود.',
    ...
    gallery: {
        ...
        description: 'در این بخش می‌توانید گوشه‌هایی از صنف‌ها، مراسم فراغت، جشن روز کودک و لحظه‌های پرشور آموزشی لیسه بین‌المللی رومی را ببینید.',
    ...
    events: {
        ...
        description: 'از مراسم فراغت تا تقدیر از شاگردان و جشن‌های کودکان، این برنامه‌ها گرمی و هویت آموزشی رومی را بازتاب می‌دهند.',
        featured: {
    ...
    faq: {
        ...
        description: 'پاسخ‌های روشن و کوتاه به سوالات رایج درباره‌ی ثبت‌نام، زندگی آموزشی، ارتباط با خانواده‌ها و حمایت از شاگردان.',
        items: faqSources.map((item) => ({
